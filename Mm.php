...
var xhttp = new XMLHttpRequest();
var post_content = "hardan="+data_sayi;

xhttp.open("GET", "ajax.php?service=ajax_xidmetler", false);
xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
xhttp.send(post_content);
document.getElementById("xidmetler").innerHTML=xhttp.responseText;
data_sayi-=12;
xhttp.onreadystatechange = function(){
}
