...
<div class="shadow p-3 mb-5 bg-white rounded">
  ...
  <li class="nav-item">
  <a class="nav-link active" href="#">Menecer Girişi</a>
  </li>
  </ul>
  </div>
...
<input id="sifre" type="text" class="form-control" placeholder="Şifre" aria-label="model" aria-describedby="basic-addon1">
</div>
